...
CREATE (DrPaco:Person:Doctor {name: 'Paco', surname: 'López', age: 55}),
	   ...
	   (DrCarmen:Person:Doctor {name: 'Carmen', surname: 'Vega', age: 45}),
       (DrRamon:Person:Doctor {name: 'Ramón', surname: 'Pérez', age: 39}),
	   ...
	   (Ana:Person:Patient {name: 'Ana', surname: 'García', age: 42}),
       (Carlos:Person:Patient {name: 'Carlos', surname: 'Fernández', age: 58}),
       (Sofia:Person:Patient {name: 'Sofia', surname: 'Martínez', age: 31}),
       (Lucas:Person:Patient {name: 'Lucas', surname: 'Díaz', age: 75}),
