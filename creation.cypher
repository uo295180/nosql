...
CREATE (DrPaco:Person:Doctor {name: 'Paco', surname: 'López', age: 55, bloodType: 'O+', gender: 'Male', height: 1.78, weight: 82}),
       ...
       (Pepe:Person:Patient {name: 'Pepe', surname: 'González', age: 34, bloodType: 'O+', gender: 'Male', height: 1.82, weight: 77}),
       (Maria:Person:Patient {name: 'Maria', surname: 'Rodríguez', age: 27, bloodType: 'O-', gender: 'Female', height: 1.65, weight: 55}),
       (Pelayo:Person:Patient {name: 'Pelayo', surname: 'Sierra', age: 20, bloodType: 'A-', gender: 'Male', height: 1.75, weight: 70}),
       (Laura:Person:Patient {name: 'Laura', surname: 'Morales', age: 36, bloodType: 'A-', gender: 'Female', height: 1.68, weight: 63}),
       (Mario:Person:Patient {name: 'Mario', surname: 'Orviz', age: 89, bloodType: 'AB+', gender: 'Male', height: 1.70, weight: 72}),
       (Pedro:Person:Patient {name: 'Pedro', surname: 'Suárez', age: 45, bloodType: 'O+', gender: 'Male', height: 1.78, weight: 80}),
       (Ana:Person:Patient {name: 'Ana', surname: 'García', age: 42, bloodType: 'B+', gender: 'Female', height: 1.60, weight: 58}),
       (Carlos:Person:Patient {name: 'Carlos', surname: 'Fernández', age: 58, bloodType: 'B+', gender: 'Male', height: 1.75, weight: 85}),
       (Sofia:Person:Patient {name: 'Sofia', surname: 'Martínez', age: 31, bloodType: 'B-', gender: 'Female', height: 1.63, weight: 50}),
       (Lucas:Person:Patient {name: 'Lucas', surname: 'Díaz', age: 75, bloodType: 'A-', gender: 'Male', height: 1.72, weight: 68}),
